...
class Backup extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('backup', 'Tungnt\Admin\Backup\BackupController@index')->name('backup-list');
            $router->get('backup/download', 'Tungnt\Admin\Backup\BackupController@download')->name('backup-download');
            $router->post('backup/run', 'Tungnt\Admin\Backup\BackupController@run')->name('backup-run');
            $router->delete('backup/delete', 'Tungnt\Admin\Backup\BackupController@delete')->name('backup-delete');
        });
    }
